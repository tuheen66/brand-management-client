...
const Home = () => {
    ...
    return (
        <div className="mb-12">
            ...
            <div className=""><img className="w-8/12 mx-auto" src="https://i.ibb.co/qY1RDqM/about.png" alt="" /></div>
            <div className="">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 my-12">
                {products.map(product => <CarCard key={product._id} product={product}></CarCard>)}
            </div>
            <Slider></Slider>
